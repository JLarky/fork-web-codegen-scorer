...
How to test lift-html:

```bash
git clone https://github.com/JLarky/fork-web-codegen-scorer.git
cd fork-web-codegen-scorer
pnpm install
export GEMINI_API_KEY="AI..."
pnpm run eval --env=lift-html-example --limit=1 # or 99 to run everything
pnpm run report # to generate http://localhost:4200/ with the report
```

<img width="904" height="755" alt="Image" src="https://github.com/user-attachments/assets/be295a57-3dea-478f-9dd2-237526d00a77" />

https://x.com/JLarky/status/1969158993722462225
